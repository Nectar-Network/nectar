...
| Both public GitHub mirrors are STALE vs the freeze | `Nectar-Network/nectar` last push 2026-07-25, `kunal-drall/nectar` 2026-08-09 — `audit-freeze-v1` + Session F/G artifacts exist only locally until pushed (the named READINESS-CHECK blocker) | 2026-08-16 | `gh repo view` both repos this session |
